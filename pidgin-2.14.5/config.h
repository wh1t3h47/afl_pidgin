...
/* configure arguments */
#define CONFIG_ARGS " 'CFLAGS=-fsanitize=address -g -O0' 'CXXFLAGS=-fsanitize=address -g -O0' 'LDFLAGS=-fsanitize=address' 'CC=afl-clang-fast' '--disable-screensaver'"
...
#define PACKAGE_STRING "pidgin 2.14.5"
